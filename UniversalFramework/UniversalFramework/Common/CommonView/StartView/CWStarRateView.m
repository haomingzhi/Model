...
#define FOREGROUND_STAR_IMAGE_NAME @"icon_love_selected"
#define BACKGROUND_STAR_IMAGE_NAME @"icon_love_unselected"
...
- (instancetype)initWithFrame:(CGRect)frame numberOfStars:(NSInteger)numberOfStars withImg:(NSString *)img withHimg:(NSString *)himg{
    if (self = [super initWithFrame:frame]) {
        _numberOfStars = numberOfStars;
        [self buildDataAndUI:img withHimg:himg];
    }
    return self;
}
...
- (void)buildDataAndUI
{
    [self buildDataAndUI:nil withHimg:nil];
}
- (void)buildDataAndUI:(NSString *)img withHimg:(NSString *)himg {
    ...
    {
        self.foregroundStarView = [self createStarViewWithImage:himg];
        self.backgroundStarView = [self createStarViewWithImage:img];
    }
