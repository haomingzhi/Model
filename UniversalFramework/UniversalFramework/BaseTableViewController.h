...
@interface BaseTableViewController : JYBaseViewController<UITableViewDataSource,UITableViewDelegate,EGORefreshTableHeaderDelegate,EGORefreshTableFooterDelegate>

@property (nonatomic) BOOL  inRefreshCurrentPage;//标记是否正在刷新当前页
@property (nonatomic) NSInteger requestCount;//网络请求个数
-(void) setTableViews;
