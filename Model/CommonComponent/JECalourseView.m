...
-(void)setDataSource:(id<JECalourseViewDataSource>)DataSource
{
    ...
    _view3=view3;
     ...
     _view1.imageView.image = [UIImage imageNamed:@"defaultBanner"];
     _view1.imageView.backgroundColor = kUIColorFromRGB(color_f8f8f8);
     _view1.imageView.contentMode = UIViewContentModeCenter;
     
     _view2.imageView.image = [UIImage imageNamed:@"defaultBanner"];
     _view2.imageView.backgroundColor = kUIColorFromRGB(color_f8f8f8);
     _view2.imageView.contentMode = UIViewContentModeCenter;
     
     _view3.imageView.image = [UIImage imageNamed:@"defaultBanner"];
     _view3.imageView.backgroundColor = kUIColorFromRGB(color_f8f8f8);
     _view3.imageView.contentMode = UIViewContentModeCenter;
    ...
    _timer=[NSTimer scheduledTimerWithTimeInterval:4.0f target:self selector:@selector(timerChange) userInfo:nil repeats:YES];
...
//     JECalourseCell *cell = (JECalourseCell *)gesture.view;
     [self.DataSource clickCellHandle:_view1];
}
