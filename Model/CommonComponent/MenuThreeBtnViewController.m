...
#import "MenuThreeBtnViewController.h"

@interface MenuThreeBtnViewController ()
{
    UILabel *_title1Lb;
    UILabel *_title2Lb;
    UILabel *_title3Lb;
...
@implementation MenuThreeBtnViewController
...
-(id)createView:(NSString *)viewName withParentView:(UIView *)v withFrame:(CGRect)frame
{
    ...
    if ([titleLb2 isKindOfClass:[UILabel class]]) {
        [titleLb2 setValue:[UIFont systemFontOfSize:14] forKey:@"font"];
