...
//// 展示状态
//typedef NS_ENUM(NSUInteger, ZLPickerCollectionViewSelectState){
//    ZLPickerCollectionViewSelectStateOneImage = 0,
//    ZLPickerCollectionViewSelectStateImages
//};
...
//选择状态
//@property (nonatomic , assign) ZLPickerCollectionViewSelectState selectState;
// scrollView滚动的升序降序
...
@property (assign,nonatomic) BOOL isShowTakePhoto;
@property (assign,nonatomic) BOOL isCanAutoChangeCheck;
@property (assign,nonatomic) BOOL isHeadPortraitScreenshot;
@property (assign,nonatomic) BOOL isDis;
// 选中的索引值，为了防止重用
...
@property (nonatomic,weak)id delegateRootVc;
@end
