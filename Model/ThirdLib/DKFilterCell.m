...
- (instancetype)init{
    if (self = [super init]) {
        ...
        _paddingBottom = 0;
        _maxViewWidth = 320;
        self.buttonNormalColor = [UIColor colorWithWhite:0.800 alpha:1.000];
        self.buttonHighlightColor = [UIColor colorWithRed:0.000 green:0.600 blue:0.663 alpha:1.000];
    }
    return self;
}
